    ...
    <div class="jumbotron">
        ...
        <div id="div_pacientes" class="container">
            <div id="patient" role="tabpanel">
                ...
                <div class="col-xs-2">
                    <a href="/preguntasPatNoPat" class="btn btn-info btn-lg btn-block"><strong>Regresar</strong></a>
                </div>

                <div class="col-xs-2">
                    <a href="/preguntasPatNoPat/{{{$preguntas->id}}}/edit" class="btn btn-warning btn-lg btn-block"><strong>Editar</strong></a>
                </div>

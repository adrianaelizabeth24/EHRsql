...
@section('content')
    ...
    <form class="jumbotron" method="post" action="{{action('PacienteController@update', $id)}}">
        {{csrf_field()}}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <select name="sexo" value="{{$paciente->sexo}}" required>
            ...
            <div class="row">
                <div class="col-md-12">
                    <input type="datetime-local" placeholder="Fecha de Nacimiento" name="nacimiento" value="{{$paciente->nacimiento}}" required/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">

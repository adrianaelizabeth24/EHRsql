            ...
            <div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<input class="form-control" type="number" name="ritmo_cardiaco" placeholder="Ritmo Cardiáco">
						<br/>
						...
						<input class="form-control" type="number" name="numero_compañeros_sexuales" placeholder="Número de Compañeros Sexuales">
						<br/>

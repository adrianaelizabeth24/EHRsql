    ...
    <form method="post" action="{{action('AntecedentesGinecobstetricosController@update', $id)}}">
        ...
        <input name="_method" type="hidden" value="PATCH"/>
            ...
            <div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<input class="form-control" type="date" name="fecha" placeholder="Fecha" value="{{$antecedentes->fecha}}"/>
						<br/>

						<input class="form-control" type="number" name="ritmo_cardiaco" placeholder="Ritmo Cardiáco" value="{{$antecedentes->ritmo_cardiaco}}">
						<br/>
						...
						<label>Número de Compañeros Sexuales</label>
						<p>{{$antecedentes->numero_compañeros_sexuales}}</p>
						<br/>
